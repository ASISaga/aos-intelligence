...
class MLConfig:
    ...
    # Azure Foundry Agent Service (azure-ai-projects v2, DefaultAzureCredential)
    ...
    foundry_aos_orchestration_id: str = ""
    ...
    def from_env(cls) -> "MLConfig":
        ...
        return cls(
            ...
            foundry_aos_orchestration_id=os.getenv("AOS_ORCHESTRATION_ID", ""),
        )
